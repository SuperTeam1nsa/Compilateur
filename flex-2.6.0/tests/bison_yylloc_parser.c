...
#line 31 "bison_yylloc_parser.y" /* yacc.c:339  */
...
#line 100 "bison_yylloc_parser.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "y.tab.h".  */
#ifndef YY_TEST_BISON_YYLLOC_PARSER_H_INCLUDED
# define YY_TEST_BISON_YYLLOC_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
union YYSTYPE
{
#line 61 "bison_yylloc_parser.y" /* yacc.c:355  */

    int  lineno;
    char * str;

#line 159 "bison_yylloc_parser.c" /* yacc.c:355  */
};
...
#endif /* !YY_TEST_BISON_YYLLOC_PARSER_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 189 "bison_yylloc_parser.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "IDENT", "LINENO", "\"=\"", "\":\"",
  "\" \"", "$accept", "file", "line", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 4:
#line 79 "bison_yylloc_parser.y" /* yacc.c:1646  */
    {
        process_text((yyvsp[-2].str));
        process_text((yyvsp[0].str));
        /* Check lineno. */
        if( (yyvsp[-5].lineno) != (yylsp[-5]).first_line || (yyvsp[-5].lineno) != testget_lineno(scanner))
        {
        ...
        printf ( "%04d: %s=%s\n", (yylsp[-5]).first_line, (yyvsp[-2].str), (yyvsp[0].str));
    }
#line 1373 "bison_yylloc_parser.c" /* yacc.c:1646  */
    break;


#line 1377 "bison_yylloc_parser.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 94 "bison_yylloc_parser.y" /* yacc.c:1906  */
